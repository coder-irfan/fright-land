...
function Volcano({ handleNotAvailable }) {
  return (
    <>
      <section
      ...
      >
        <div className="relative z-10 mx-auto px-4 sm:px-6 md:px-8 max-w-[50rem] lg:max-w-[75rem]">
          ...
          >
            <div
              className="flex items-center justify-center flex-col text-center lg:max-w-[26.25rem] xl:max-w-[31.25rem] w-full p-4 
            ...
            >
              ...
              <p className="opacity-75 text-fright-textColor sm:px-6 lg:px-12">
                Of course, if she manages to leave the volcano first. We have
                prepared a special labyrinth for her.
              </p>

              <div className="flex md:items-center justify-center flex-wrap gap-3 lg:gap-5 text-fright-whiteshColor pt-4 md:pt-10">
                <button
                ...
                <div className="btn-gradient-border transition-shadow duration-300 hover:shadow-[0_0_1rem] hover:shadow-fright-darkGradientVioled">
                  <button className="flex items-center btn-inner gap-2 lg:gap-3 text-sm lg:text-base font-bold">
                    Learn more
                  </button>
                </div>
              </div>
